...
OBJECTIVE_MODES: dict[str, ObjectiveMode] = {
    "standard": ObjectiveMode(
        ...
        description="Use an independently verifiable LLM candidate as the only generated implementation path.",
        primary_metric="maintainability",
        secondary_metrics=("functional_verification", "synthesis_success"),
        preferred_path_policy="llm_candidate_path > honest_unsupported_boundary",
        candidate_policy="Use the constrained LLM candidate flow and reject claims without an independent verification contract.",
        ...
        planner_effect="Planner keeps candidate generation, verification, synthesis, and report parsing in a fixed dependency chain.",
        specialist_effect="CodegenSpecialist and Verification/Vivado specialists own the candidate lifecycle.",
    ),
    "resource": ObjectiveMode(
        ...
        preferred_path_policy="Choose a verified low-resource LLM candidate when it satisfies the target contract.",
    ...
    "latency": ObjectiveMode(
        ...
        preferred_path_policy="Choose a verified low-latency LLM candidate when resources remain feasible.",
    ...
    "performance": ObjectiveMode(
        ...
        preferred_path_policy="Explore guarded LLM candidates for performance, then require independent verification.",
    ...
    "balanced": ObjectiveMode(
        ...
        preferred_path_policy="Compare verified LLM candidates using an explicit resource budget.",
