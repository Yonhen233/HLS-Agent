"""Test contracts and regression checks for test_demo_examples_schema.py.
...
def _validate_example(filename: str) -> dict:
    """Verify the _validate_example contract.
...
def test_dense_operator_schema_valid():
    """Verify the test_dense_operator_schema_valid contract.
...
def test_matmul_resource_schema_valid():
    """Verify the test_matmul_resource_schema_valid contract.
...
def test_mnist_mlp_schema_valid():
    """Verify the test_mnist_mlp_schema_valid contract.
...
def test_generic_mlp_fixture_is_a_real_static_onnx_model():
    """Verify the test_generic_mlp_fixture_is_a_real_static_onnx_model contract.
...
def test_mnist_recognition_mlp_schema_valid():
    """Verify the test_mnist_recognition_mlp_schema_valid contract.
...
def test_mnist_tiny_cnn_schema_valid():
    """Verify the test_mnist_tiny_cnn_schema_valid contract.
...
def test_mnist_qkeras_schema_valid():
    """Verify the test_mnist_qkeras_schema_valid contract.
...
def test_mnist_qonnx_schema_valid():
    """Verify the test_mnist_qonnx_schema_valid contract.
...
def test_tiny_residual_schema_valid():
    """Verify the test_tiny_residual_schema_valid contract.
...
def test_resnet_boundary_schema_valid():
    """Verify the test_resnet_boundary_schema_valid contract.
...
def test_scale_shift_llm_candidate_schema_valid():
    """Verify the test_scale_shift_llm_candidate_schema_valid contract.
...
def test_fallback_operator_llm_candidate_schema_valid(filename, op_type):
    """Verify the test_fallback_operator_llm_candidate_schema_valid contract.
...
def test_graph_rewrite_suggests_gemm_decomposition():
    """Verify the test_graph_rewrite_suggests_gemm_decomposition contract.
...
def test_operator_schema_rejects_dynamic_shape():
    """Verify the test_operator_schema_rejects_dynamic_shape contract.
...
def test_operator_schema_rejects_invalid_fixed_point_dtype():
    """Verify the test_operator_schema_rejects_invalid_fixed_point_dtype contract.
...
def test_operator_schema_rejects_inconsistent_matmul_shapes():
    """Verify the test_operator_schema_rejects_inconsistent_matmul_shapes contract.
...
def test_graph_rewrite_suggests_static_shape_elimination():
    """Verify the test_graph_rewrite_suggests_static_shape_elimination contract.
...
def test_graph_rewrite_rewrites_onnx_gemm_to_matmul_add(tmp_path):
    """Verify the test_graph_rewrite_rewrites_onnx_gemm_to_matmul_add contract.
