"""Test contracts and regression checks for test_workspace_context.py.
...
def test_incremental_mixed_workspace_index_and_citations(tmp_path):
    """Verify the test_incremental_mixed_workspace_index_and_citations contract.
...
def test_workspace_context_rejects_read_outside_policy(tmp_path):
    """Verify the test_workspace_context_rejects_read_outside_policy contract.
